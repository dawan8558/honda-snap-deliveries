-- Fix frame URLs to point to public folder instead of src folder
UPDATE public.frames SET 
  image_url = '/frames/honda-professional-frame.png',
  name = 'Honda Professional Frame'
WHERE model = 'Accord';

UPDATE public.frames SET 
  image_url = '/frames/honda-civic-branded-frame.png',
